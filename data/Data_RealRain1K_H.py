...
#     parser.add_argument('--dataroot', type=str, default=r'D:\DataSets\Derain_change\RealRain-1k-H')
...
class Train_RealRain1K_H_Dataset(Dataset):
    def __init__(self, opt):
        super(Train_RealRain1K_H_Dataset, self).__init__()
        # self.root_dir = os.path.join(opt['data_root'], 'train')
...
class Train_RealRain1K_H_Aug_Dataset(Dataset):
    def __init__(self, opt, patch_size):
        super(Train_RealRain1K_H_Aug_Dataset, self).__init__()
        # self.root_dir = os.path.join(opt['data_root'], 'train')
        self.root_dir = opt['data_root']
...
class Test_RealRain1K_H_Dataset_whole_resolution(Dataset):
    def __init__(self, opt):
        super(Test_RealRain1K_H_Dataset_whole_resolution, self).__init__()
        # self.root_dir = os.path.join(opt['data_root'], 'test')
        self.root_dir = opt['data_root']
...
class Val_RealRain1K_H_Dataset(Dataset):
    def __init__(self, opt):
        super(Val_RealRain1K_H_Dataset, self).__init__()
        # self.root_dir = os.path.join(opt['data_root'], 'test')
        self.root_dir = opt['data_root']
...
if __name__ == '__main__':
    ...
    traindataset = Train_RealRain1K_H_Aug_Dataset()
